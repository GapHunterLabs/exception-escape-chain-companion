package dev.gaphunter.exceptionescapechaincompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.exceptionescapechaincompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.exceptionescapechaincompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Exception-Escape Chain Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34013-exception-escape-chain-companion/reviews"
